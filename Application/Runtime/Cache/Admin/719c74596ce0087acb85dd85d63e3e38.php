	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="content"><?php echo (msubstr($vo["content"],0,18)); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                <td class="status"><?php if($vo["isread"] == 0 ): ?><span style="color:blue">未读</span><?php else: ?><span style="color:red">已读</span><?php endif; ?></td>
                <td class="operate">
...
$(function(){
	...
	$('.show').on('click',function(){
		...
		layer.open({
            ...
            shade: 0.8,  
            area: ['450px', '90%'],
            content: '/index.php/Admin/Email/getContent/id/'+id //iframe的url,id 后面不加标点符号
        }); 
	});
});
</script>
