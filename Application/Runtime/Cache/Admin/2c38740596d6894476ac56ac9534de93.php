...
<div class="table-box">
	<table>
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><?php echo ($vol["filename"]); ?> <?php if($vol["hasfile"] == 1 ): ?>【<a href="javascript:;" class="download" id="<?php echo ($vol["id"]); ?>">下载</a>】<?php endif; ?></td>
                ...
                <td class="operate">
					...
					<a href="/index.php/Admin/Doc/del/id/<?php echo ($vol["id"]); ?>">删除</a>
                </td>
...
$(function(){
	...
	$('.show').on('click',function(){
		...
		layer.open({
			  ...
			  shade: 0.8,
			  area: ['380px', '90%'],
			  content: '/index.php/Admin/Doc/docContent/id/' + id //iframe的url
			});
	});
});
