...
<head>
    ...
    <script type="text/javascript" src="/api49/Public/js/jquery.js"></script>
    <script>
    ...
    $(function() {
        ...
        $("#getCodeBtn").click(function() {
            ...
            $.ajax({
                type: 'get',
                url: 'http://www.test.com/api49/index.php/Api/User/send/telphone/' + telphone,
...
<body>
    <div>
        <form action="http://www.test.com/api49/index.php/Api/User/register" method="post">
            <table>
                <tr>
                    <td>姓名</td>
                    <td>
